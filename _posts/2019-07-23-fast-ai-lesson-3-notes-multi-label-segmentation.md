...
- `get_transforms` creates a list of a image transformations. 
  ![image-20190716233120785]({{site.baseurl}}/images/fastai/image-20190716233120785.png)
...
![image-20190713221942444]({{site.baseurl}}/images/fastai/image-20190713221942444.png)
...
![image-20190717172222609]({{site.baseurl}}/images/fastai/image-20190717172222609.png)
...
![image-20190722203413595]({{site.baseurl}}/images/fastai/image-20190722203413595.png)
...
![image-20190723113041138]({{site.baseurl}}/images/fastai/image-20190723113041138.png)
...
![image-20190723115918520]({{site.baseurl}}/images/fastai/image-20190723115918520.png)
...
![image-20190723140846030]({{site.baseurl}}/images/fastai/image-20190723140846030.png)

These days the workhorse is the __rectified linear unit (ReLU)__:

![image-20190723140947121]({{site.baseurl}}/images/fastai/image-20190723140947121.png)
...
- [Link to Lesson 3 lecture](https://youtu.be/MpZxV6DVsmM)
- Homework notebooks:
